...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'dictionary');

		$('.daterangepicker_end_input').attr('data-grid', 'dictionary');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('dictionary', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);

...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'dictionaryentries');

		$('.daterangepicker_end_input').attr('data-grid', 'dictionaryentries');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('dictionaryentries', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
